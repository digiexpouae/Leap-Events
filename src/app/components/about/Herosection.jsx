...
// Blob/tagline/text animations run on every breakpoint — only the video's scroll-zoom is desktop-only
...
:"M1266 582L1302 -3000H1419C1397.83 165.167 1353 512.8 1343 582C1333 651.2 1387.5 668.167 1416 668L8000 733.5V5000H-5000V562.5C372.833 585.667 1132.2 633 1187 637C1241.8 641 1262.5 602 1266 582Z"
    ...
    // Video stays hidden until the intro reveal finishes — on both mobile and desktop
    
    gsap.set(".hero-video", {opacity: 0, scale: 0.4,borderRadius:"50px"})
          mm.add("(max-width: 1024px)", () => {
            gsap.set(".hero-video", {scaleX: 0.6,scaleY:0.3})
          })
    ...
    transform: "translate(0,0)",
      ...
      // Reveal the video only once the intro reveal above has finished
      tl2.to(".hero-video", {opacity:1, ease:"power2.out"})
      mm.add("(max-width: 768px)", () => {
              tl2.to(".hero-video-mob", {opacity:1, ease:"power2.out"})
      ...
      // Zoom the video in as the user scrolls through the pinned section — desktop only
  ...
  return (
    <section ref={sectionRef} dir="ltr" className="relative h-screen overflow-hidden bg-white">
       <div className="absolute left-0 top-0 z-10 mx-auto max-w-7xl px-6 translate-y-30 md:px-12">
        <p className="hero-tagline w-[190px] md:w-[420px] text-xs md:text-lg font-semibold uppercase leading-relaxed tracking-tight text-[#363737]" style={{opacity:0}}>
...
<div className="hero-video-mob md:hidden block absolute z-40  top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 overflow-hidden rounded-xl shadow-xl h-[210px] w-[330px] "
