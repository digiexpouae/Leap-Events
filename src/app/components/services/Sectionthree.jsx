...
function ServiceCard({ title, subtitle, body }) {
    return (
        <div className="flex flex-col gap-3 mb-4 bg-primary-two   md:h-[400px]  py-8 px-10 border-gray-200">
            <h3 className="text-[color:var(--color-heading)] uppercase text-xl lg:text-3xl tracking-tighter leading-snug">
                {title}
            </h3>
            <p className=" font-semibold text-lg md:text-xl  leading-[1.4] tracking-tighter">
                {subtitle}
            </p>
            <p className="text-sm leading-[1.2] tracking-tighter">
                {body}
            </p>
        </div>
    );
...
export default function CreativeStrategySection({
    ...
    return (
        <>
            ...
            <p className="h-[1.4px]  bg-[#5A5A5A] mx-4  md:mx-auto max-w-5xl"></p>
